...
#define UART_PAD_CTRL	(PAD_CTL_HYS | PAD_CTL_DSE_HIGH | \
			 PAD_CTL_PUS_100K_UP | PAD_CTL_PUE | PAD_CTL_ODE)

static void setup_iomux_uart(void)
{
	static const iomux_v3_cfg_t uart_pads[] = {
		NEW_PAD_CTRL(MX53_PAD_PATA_DMACK__UART1_RXD_MUX,0x1E4),
		NEW_PAD_CTRL(MX53_PAD_PATA_DIOW__UART1_TXD_MUX,0x1E4),
		
		NEW_PAD_CTRL(MX53_PAD_CSI0_DAT13__UART4_RXD_MUX,0x1E4),
		NEW_PAD_CTRL(MX53_PAD_CSI0_DAT12__UART4_TXD_MUX,0x1E4),
	};
...
#define I2C_PAD_CTRL	(PAD_CTL_SRE_FAST | PAD_CTL_DSE_HIGH | \
			 PAD_CTL_PUS_100K_UP | PAD_CTL_ODE | PAD_CTL_HYS)
...
static void setup_iomux_i2c(void)
{
	...
	static const iomux_v3_cfg_t i2c3_pads[] = {
		NEW_PAD_CTRL(MX53_PAD_GPIO_6__I2C3_SDA, I2C_PAD_CTRL),
		NEW_PAD_CTRL(MX53_PAD_GPIO_3__I2C3_SCL, I2C_PAD_CTRL),
	};
