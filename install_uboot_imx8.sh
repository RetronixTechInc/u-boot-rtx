...
BRANCH_VER="lf-5.15.32_2.0.0"
BRANCH_VER_ATF="lf-5.4.y"
DDR_FW_VER="8.17"
...
install_firmware()
{
	...
	if [ ! -d imx-atf ] ; then
		git clone https://source.codeaurora.org/external/imx/imx-atf -b ${BRANCH_VER_ATF} || printf "Fails to fetch ATF source code \n"
	fi
	cd imx-atf
...
generate_imx_boot()
{
	...
	cp ${TWD}/${MKIMAGE_DIR}/${SOC_DIR}/${IMX_BOOT} ${TWD}/out/
}
