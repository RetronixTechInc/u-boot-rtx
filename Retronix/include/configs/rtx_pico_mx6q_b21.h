 ...
 */
...
#ifndef __RTX_PICO_MX6Q_B21_CONFIG_H
	#define __RTX_PICO_MX6Q_B21_CONFIG_H
	...
	#define CONFIG_ENV_IS_IN_MMC
		...
		#if defined(CONFIG_RTX_PARTITION_0_UBOOT_ARGUMENT_OFFSET)
			#define CONFIG_ENV_OFFSET				(CONFIG_RTX_PARTITION_0_UBOOT_ARGUMENT_OFFSET)
		#else
