...
#define BOARD_PAD_UART5_MODE0			IMX_GPIO_NR(6,14)
#define BOARD_PAD_UART5_MODE1			IMX_GPIO_NR(6, 7)
#define BOARD_PAD_UART5_ENABLE			IMX_GPIO_NR(6,16)
#define BOARD_PAD_USB_OTG_PWR_EN		IMX_GPIO_NR(4, 5)
