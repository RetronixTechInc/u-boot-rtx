	...
	*/
	...
	#define CONFIG_ANDROID_RECOVERY_BOOTARGS \
		...
		#endif
        #define CONFIG_EXTRA_ENV_BOOTARGS_ANDROID "bootargs_android=setenv bootargs ${bootargs} androidboot.hardware=retronix androidboot.console=" CONFIG_CONSOLE_ANDROID "\0"
	#else
		#ifdef CONFIG_EXTRA_ENV_USE_DTB
