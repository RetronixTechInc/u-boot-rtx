...
#ifndef __RTX_Q7_MX6Q_CONFIG_H
	#define __RTX_Q7_MX6Q_CONFIG_H
	...
	*/
	...
	#else
		/*ldb*/
		#define CONFIG_BOOTARGS         			"console=ttymxc0,115200 rootfs=/dev/ram0 rdinit=/init rootwait video=mxcfb0:dev=ldb,if=RGB666,fbpix=RGB666 fec_mac=00:03:2d:29:5f:24"
	#endif
	...
	#define CONFIG_SYS_PROMPT		                "RTX-Q7 MX6D MFG U-Boot > "
