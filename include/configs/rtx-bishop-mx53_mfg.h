...
#define CONFIG_MACH_TYPE	MACH_TYPE_RTX_BISHOP_MX53
...
#define CONFIG_BOOTCOMMAND      "mmc dev 1;mmc read ${loadaddr} 0x6800 0x3000; mmc read ${dtb_loadaddr} 0x5000 0x1000;bootm 0x70800000 - 0x70D00000"
