...
#define CONFIG_DEF_LOADADDR		0x40480000
#define CONFIG_DTB_LOADADDR		0x43000000
#define CONFIG_RD_LOADADDR		0x43800000

#define CONFIG_UPDATEROOT		"/dev/mmcblk1p1"

#define CONFIG_BOOTSEL_FUNC_MENU
#define CONFIG_BOOTSEL_FUNC_CHG_STORAGE
...
/*#define CONFIG_ENG_BOOTCMD  \
	"setenv bootargs console=${console}; run ext_args; booti 0x40480000 0x43800000"
#define CONFIG_ENG_DTB_BOOTCMD  \
	"setenv bootargs console=${console}; run ext_args; booti 0x40480000 0x43800000 0x43000000"*/
#define CONFIG_ENG_BOOTCMD  \
...
#define CONFIG_RTX_EFM32
	...
	#define CONFIG_MCU_WATCHDOG_TIME	0
...
/*	"netargs=setenv bootargs ${jh_clk} ${mcore_clk} console=${console} " \
	...
	"r_ramdisk=mmc read ${initrd_addr} 0xE000 0x8000\0" \
	...
	"ramboot2=echo Booting to ramdisk 2 ...; run ramargs; " \
		"run loadimage loadfdt r_ramdisk; booti ${loadaddr} ${initrd_addr} ${fdt_addr};\0" \
