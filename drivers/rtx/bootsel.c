...
static int do_set_bootsel_setting(struct cmd_tbl *cmdtp, int flag, int argc,
		       char * const argv[])
{
printf("%s(%d)\n", __func__, __LINE__);
	int loop ;
...
static int do_reset_env(struct cmd_tbl *cmdtp, int flag, int argc,
		       char * const argv[])
{
...
static int do_reset_setting(struct cmd_tbl *cmdtp, int flag, int argc,
		       char * const argv[])
{
	memset( (void *)&bootselinfodata , 0 , sizeof(bootselinfo) ) ;
...
static int do_show_setting_info(struct cmd_tbl *cmdtp, int flag, int argc,
		       char * const argv[])
{
	int loop , loop1 ;
	unsigned long * ulval ;
